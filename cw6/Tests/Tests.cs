...
public class PrescriptionTests
{
    ...
    public void Setup()
    {
        ...
        _medicamentRepositoryMock
            .Setup(repo => repo.GetMedicament(It.Is<string>(name => name == "NonExistentMedicament"),
        ...
        _prescriptionRepositoryMock
            .Setup(repo =>
                repo.AddPrescriptionMedicament(It.IsAny<Prescription_Medicament>(), It.IsAny<CancellationToken>()));
    ...
    public async Task AddPrescription_TooManyMedicaments_ReturnsBadRequest()
    {
        ...
        //Assert
        Assert.That(result is BadRequestObjectResult);
        Assert.That("Prescription cannot include more than 10 medicaments",
            Is.EqualTo(((BadRequestObjectResult)result).Value));
    }
    ...
    public async Task AddPrescription_DueDateBeforeDate_ReturnsBadRequest()
    {
        ...
        //Assert
        Assert.That(result is BadRequestObjectResult);
        Assert.That("Prescription date cannot be after its due date",
            Is.EqualTo(((BadRequestObjectResult)result).Value));
